...
class WeCaseWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, mainWindow):
        ...
        self.action_About.setIcon(QtGui.QIcon(QtGui.QPixmap("./IMG/img/where_s_my_weibo.svg")))
        self.action_Exit.setIcon(QtGui.QIcon(QtGui.QPixmap(":/IMG/img/application-exit.svg")))
        self.action_Settings.setIcon(QtGui.QIcon(QtGui.QPixmap(":/IMG/img/preferences-other.png")))
        ...
        self.mainMenu.addAction(self.action_Refresh)
        self.mainMenu.addSeparator()
        self.mainMenu.addAction(self.action_Log_out)
        self.mainMenu.addAction(self.action_Exit)
        self.helpMenu.addAction(self.action_About)
        self.OptionsMenu.addAction(self.action_Settings)
