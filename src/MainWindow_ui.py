...
class Ui_frm_MainWindow(object):
    def setupUi(self, frm_MainWindow):
        ...
        frm_MainWindow.setDocumentMode(False)
        frm_MainWindow.setDockOptions(QtGui.QMainWindow.AllowTabbedDocks|QtGui.QMainWindow.AnimatedDocks)
        ...
        self.gridLayout_2 = QtGui.QGridLayout(self.homeTab)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.homeView = TweetListWidget(self.homeTab)
        ...
        self.mentionsTab = QtGui.QWidget()
        self.mentionsTab.setObjectName(_fromUtf8("mentionsTab"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.mentionsTab)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.mentionsView = TweetListWidget(self.mentionsTab)
        self.mentionsView.setObjectName(_fromUtf8("mentionsView"))
        self.verticalLayout_3.addWidget(self.mentionsView)
        self.tabWidget.addTab(self.mentionsTab, _fromUtf8(""))
        self.commentsTab = QtGui.QWidget()
        self.commentsTab.setObjectName(_fromUtf8("commentsTab"))
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.commentsTab)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.commentsView = TweetListWidget(self.commentsTab)
        self.commentsView.setObjectName(_fromUtf8("commentsView"))
        self.verticalLayout_4.addWidget(self.commentsView)
        self.tabWidget.addTab(self.commentsTab, _fromUtf8(""))
        self.myTab = QtGui.QWidget()
        self.myTab.setObjectName(_fromUtf8("myTab"))
        self.verticalLayout_5 = QtGui.QVBoxLayout(self.myTab)
        self.verticalLayout_5.setObjectName(_fromUtf8("verticalLayout_5"))
        self.myView = TweetListWidget(self.myTab)
        self.myView.setObjectName(_fromUtf8("myView"))
        self.verticalLayout_5.addWidget(self.myView)
        self.tabWidget.addTab(self.myTab, _fromUtf8(""))
    ...
    def retranslateUi(self, frm_MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.homeTab), _translate("frm_MainWindow", "Weibo", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.mentionsTab), _translate("frm_MainWindow", "@ME", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.commentsTab), _translate("frm_MainWindow", "Comments", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.myTab), _translate("frm_MainWindow", "My tweet", None))
